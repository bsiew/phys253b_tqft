...
Session-generated review docs directory: `PROJECTS/QFT/253b_final_paper/llm_docs/logs`
...
- High-value figure opportunities are now tracked in one combined inventory at `state/writing/figure_inventory.md`, with a full git-local copy at `253b_final_paper/llm_docs/current/figure_inventory.md`.
...
3. Turn the strongest entries in the combined figure inventory into formal figure specs before generating visuals.
...
- Best handoff format: give Claude one module at a time plus the style guide in `253b_final_paper/llm_docs/current/writing_style_guide.md`, then bring the result back through Codex for consistency, file placement, and notation audit.
