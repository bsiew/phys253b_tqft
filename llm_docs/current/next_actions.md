...
conceptual_and_formal_modeling

## Current bottleneck

Pedagogical rewrite and compile integration are in place; remaining bottleneck is technical/convention verification plus figure specification.
...
## Completion signal for this mini-cycle

The final paper has dense modular TeX files that compile under the shared preamble, pass notation/cross-reference review, preserve the teacherly mathematical style, and have prioritized figure specs.
