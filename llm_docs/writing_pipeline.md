...
- Scope: Integrate the Brian and Helena Chern-Simons reviews into modular TeX files under PROJECTS/QFT/253b_final_paper/tex_docs, with human-useful LLM review docs under PROJECTS/QFT/253b_final_paper/llm_docs.
