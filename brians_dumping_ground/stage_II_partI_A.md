...
**Duration:** 1.5 days (target: Day 1 afternoon through Day 2).
**Lead:** Brian.
...
| # | Task | File |
|---|---|---|
| 2.1 | Draft §2.1 (forms, wedge, exterior derivative) — **done 2026-05-03** | [02_1_forms_basics.md](../tasks/02_1_forms_basics.md) |
| 2.2 | Draft §2.2 (integration, Stokes, de Rham) — **done 2026-05-04** | [02_2_integration_stokes.md](../tasks/02_2_integration_stokes.md) |
| 2.3 | Draft §2.3 (Lie-algebra-valued forms and conventions) — **done 2026-05-04** | [02_3_lie_algebra_forms.md](../tasks/02_3_lie_algebra_forms.md) |
| 2.4 | Draft §2.4 (principal bundles at minimum level) — **done 2026-05-04** | [02_4_principal_bundles.md](../tasks/02_4_principal_bundles.md) |
| 2.5 | Draft §2.5 (gauge transformations and $F^g = g^{-1}Fg$) — **done 2026-05-04** | [02_5_gauge_transformations.md](../tasks/02_5_gauge_transformations.md) |
| 2.6 | Two worked examples (EM, $S^1 \to S^1$ winding) — **done 2026-05-04** | [02_6_worked_examples.md](../tasks/02_6_worked_examples.md) |
| 2.7 | Scope-check to ~10 pp — **done 2026-05-04** | [02_7_scope_check.md](../tasks/02_7_scope_check.md) |
...
### Chapter 5 Addendum — Witten–Jones Bridge (~3–5 pp, optional but important)

| # | Task | File |
|---|---|---|
| 5.1 | Add compact Witten–Jones bridge subsection (skein relation, Hopf-link example, no surgery derivation) | [05_1_witten_jones_bridge.md](../tasks/05_1_witten_jones_bridge.md) |
...
- Chapter 2 is drafted without destabilizing the standalone `paper/chern_simons_theory.tex`; any deduplication with Chapter 5 is deferred until integration.
