...
Work through one gluing example explicitly, as mandated by outline v2's "Must include: a concrete example of gluing and how it implements composition of amplitudes."
