...
%   (Maxwell-CS), write 11.7 (honesty box).
%
...
%   11.7  Honesty box: what is clean, what is mesoscopic (= old Sec 5.6 + task 11_5)
%
% Owner: Helena
% Stage: IV
%
...
% TODO (Task 11_1): Expand from the opening paragraphs below to ~2 pages.
% Add: Hall bar geometry, MOSFET vs GaAs/AlGaAs, Landau levels E_n,
% filling fraction nu, integer vs fractional plateaus.
% The current opening (migrated below) jumps straight to the FQHE;
% add the experimental context first.
% Cite: Tong QHE, Laughlin 1983, Tsui-Stormer-Gossard 1982.
...
% TODO: Write this subsection. Merges BSIEW task 11_5 (honesty box on platform
% status) with the current Sec 5.6 caveat outline.
%
% Part A: Platform honesty box (task 11_5, required by rubric).
%   1. Abelian anyons (Laughlin, Jain): braiding stats directly measured
%      (Nakamura 2020, Werkmeister 2024; see Ch 12).
%   2. Non-abelian anyons (nu=5/2 Moore-Read, Majorana heterostructures,
%      twisted bilayer graphene): not unambiguously confirmed.
%   3. Quantum processor emulations (Andersen 2023): synthetic, not natural
%      phase. See Ch 12 Sec 12.3.
%
% Part B: Mesoscopic caveats (from tqft_observables_literature_review Sec 4.5).
%   - Interferometry: Coulomb-dominated regimes, area fluctuations, slow
%     quasiparticle dynamics, edge reconstruction.
%   - Edge-mode counting: chirality and anomaly coefficient topological;
%     velocities, equilibration, tunneling exponents not.
%   - K-matrix does not encode gravitational response (Wen-Zee term).
%
